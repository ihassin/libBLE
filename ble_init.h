...
/**
 * ble_init.c/.h contains all functions necessary
 * to initialize Bluetooth Low Energy functionalities
 */
...
#define DEVICE_NAME                     "SentientLightLED"                               /**< Name of device. Will be included in the advertising data. */
